  ...
  <div class="parallax-container valign-wrapper s12" >
    <div class="section no-pad-bot">
      <div class="container ">
        ...
        <div class="row center">
          <a href="Forum.php" id="cadastroForum" class="btn-large waves-effect waves-light teal lighten-1">Entrar</a>
        </div>
...
<div class="container">
  <div class="section">
    ...
    <div class="row center">
      <a href="Parceiros.php" id="cadastroParceiro" class="btn-large waves-effect waves-light teal lighten-1">Cadastre-se como Parceiro</a>
    </div>
  </div>
</div>
<br  id="secaoNos">
